...
public interface IXmlType {
   ...
   *         otherwise
   */
  boolean isInline(@NonNull IXmlGenerationState state);
   ...
   */
  boolean isGeneratedType(@NonNull IXmlGenerationState state);
   ...
   */
  void generate(@NonNull IXmlGenerationState state);
   ...
   */
  boolean isReferenced(@NonNull IXmlGenerationState state);
}
