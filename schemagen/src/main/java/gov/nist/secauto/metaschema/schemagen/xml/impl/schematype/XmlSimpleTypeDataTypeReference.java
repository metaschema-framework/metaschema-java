...
/**
 * Represents a reference to a built-in XML Schema data type.
 * <p>
 * This class provides a reference to an existing data type that is not
 * generated by the schema generator, but is instead handled by the data type
 * manager. The type is referenced by its qualified name without generating any
...
public class XmlSimpleTypeDataTypeReference
   ...
   *
   * @param typeName
   *          the qualified name of the referenced data type
   * @param dataTypeAdapter
   *          the data type adapter that handles value conversion
   */
