 ...
 * Key classes:
 * <ul>
 * <li>{@link gov.nist.secauto.metaschema.maven.plugin.AbstractMetaschemaMojo} -
 * Base class providing common functionality for module loading, constraint
 * handling, and incremental build support</li>
 * <li>{@link gov.nist.secauto.metaschema.maven.plugin.GenerateSourcesMojo} -
 * Generates Java binding classes from Metaschema modules</li>
 * <li>{@link gov.nist.secauto.metaschema.maven.plugin.GenerateSchemaMojo} -
 * Generates schema files from Metaschema modules</li>
 * </ul>
 * <p>
 ...
 * }</pre>
 *
 * @see gov.nist.secauto.metaschema.maven.plugin.GenerateSourcesMojo
 * @see gov.nist.secauto.metaschema.maven.plugin.GenerateSchemaMojo
 */
