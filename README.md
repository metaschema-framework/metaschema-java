...
This library is maintained to be feature compatible with the features in the NIST [v1.0.0-M1](https://github.com/usnistgov/metaschema-java/releases/tag/v1.0.0-M1) release. This means that Metaschema-based content produced for either will work with this library. Flaws have been fixed in cases where flaws have been identified in the NIST version and confirmed to present in this library. This has been noted in related [issues](https://github.com/usnistgov/metaschema-java/issues) in the NIST repository.
