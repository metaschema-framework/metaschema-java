...
The test suite binding classes in `dev.metaschema.model.testing.testsuite` are pre-generated and checked into source control. This is necessary because:
...
cp -r metaschema-testing/target/generated-sources/metaschema/dev/metaschema/model/testing/testsuite/* \
      metaschema-testing/src/main/java/dev/metaschema/model/testing/testsuite/
```

The binding configuration (`src/main/metaschema-bindings/test-suite-bindings.xml`) maps the namespace to the `dev.metaschema.model.testing.testsuite` package.
