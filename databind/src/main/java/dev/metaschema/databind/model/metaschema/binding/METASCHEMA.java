...
@MetaschemaAssembly(
    ...
    modelConstraints = @dev.metaschema.databind.model.annotations.AssemblyConstraints(
...
public class METASCHEMA implements IBoundObject {
  ...
  /**
   * Constructs a new
   * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA} instance
   * with no metadata.
   */
  public METASCHEMA() {
    this(null);
  ...
  public static class Import implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA.Import}
  ...
  public static class DefineAssembly implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA.DefineAssembly}
     * instance with no metadata.
     */
    ...
    public static class RootName implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA.DefineAssembly.RootName}
       * instance with no metadata.
       */
      public RootName() {
        this(null);
  ...
  public static class DefineField implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA.DefineField}
     * instance with no metadata.
     */
    public DefineField() {
      this(null);
  ...
  public static class DefineFlag implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.METASCHEMA.DefineFlag}
     * instance with no metadata.
     */
    public DefineFlag() {
      this(null);
