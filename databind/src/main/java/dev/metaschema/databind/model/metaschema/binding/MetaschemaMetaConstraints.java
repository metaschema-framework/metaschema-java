...
@MetaschemaAssembly(
    ...
    modelConstraints = @dev.metaschema.databind.model.annotations.AssemblyConstraints(unique = {
...
public class MetaschemaMetaConstraints implements IBoundObject {
  ...
  /**
   * Constructs a new
   * {@code dev.metaschema.databind.model.metaschema.binding.MetaschemaMetaConstraints}
  ...
  public static class Import implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.MetaschemaMetaConstraints.Import}
     * instance with no metadata.
     */
    public Import() {
      this(null);
  ...
  public static class DefinitionContext implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.MetaschemaMetaConstraints.DefinitionContext}
     * instance with no metadata.
     */
