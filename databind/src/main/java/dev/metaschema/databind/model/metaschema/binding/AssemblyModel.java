...
public class AssemblyModel implements IBoundObject {
  ...
  /**
   * Constructs a new
   * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel}
  ...
  public static class Choice implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.Choice}
     * instance with no metadata.
     */
    public Choice() {
      this(null);
  ...
  public static class ChoiceGroup implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.ChoiceGroup}
     * instance with no metadata.
     */
    public ChoiceGroup() {
      this(null);
    ...
    public static class Assembly implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.ChoiceGroup.Assembly}
       * instance with no metadata.
       */
      public Assembly() {
        this(null);
    ...
    public static class DefineAssembly implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.ChoiceGroup.DefineAssembly}
       * instance with no metadata.
       */
    ...
    public static class Field implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.ChoiceGroup.Field}
       * instance with no metadata.
       */
      public Field() {
        this(null);
    ...
    public static class DefineField implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.model.metaschema.binding.AssemblyModel.ChoiceGroup.DefineField}
       * instance with no metadata.
       */
      public DefineField() {
        this(null);
