...
public class MetaschemaBindings implements IBoundObject {
  ...
  /**
   * Constructs a new
   * {@code dev.metaschema.databind.config.binding.MetaschemaBindings} instance
   * with no metadata.
   */
  ...
  public static class ModelBinding implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.ModelBinding}
    ...
    public static class Java implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.ModelBinding.Java}
       * instance with no metadata.
       */
      public Java() {
        this(null);
  ...
  public static class MetaschemaBinding implements IBoundObject {
    ...
    /**
     * Constructs a new
     * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding}
     * instance with no metadata.
     */
    ...
    public static class DefineAssemblyBinding implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding}
       * instance with no metadata.
       */
      ...
      public static class Java implements IBoundObject {
        ...
        /**
         * Constructs a new
         * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding.Java}
         * instance with no metadata.
         */
        public Java() {
          this(null);
      ...
      public static class PropertyBinding implements IBoundObject {
        ...
        /**
         * Constructs a new
         * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding.PropertyBinding}
         * instance with no metadata.
         */
        ...
        public static class Java implements IBoundObject {
          ...
          /**
           * Constructs a new
           * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding.PropertyBinding.Java}
           * instance with no metadata.
           */
          public Java() {
            this(null);
      ...
      public static class ChoiceGroupBinding implements IBoundObject {
        ...
        /**
         * Constructs a new
         * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding.ChoiceGroupBinding}
         * instance with no metadata.
         */
        ...
        public static class ItemType implements IBoundObject {
          ...
          /**
           * Constructs a new
           * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineAssemblyBinding.ChoiceGroupBinding.ItemType}
           * instance with no metadata.
           */
          public ItemType() {
            this(null);
    ...
    public static class DefineFieldBinding implements IBoundObject {
      ...
      /**
       * Constructs a new
       * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineFieldBinding}
       * instance with no metadata.
       */
      ...
      public static class Java implements IBoundObject {
        ...
        /**
         * Constructs a new
         * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineFieldBinding.Java}
         * instance with no metadata.
         */
        public Java() {
          this(null);
      ...
      public static class PropertyBinding implements IBoundObject {
        ...
        /**
         * Constructs a new
         * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineFieldBinding.PropertyBinding}
         * instance with no metadata.
         */
        public PropertyBinding() {
          this(null);
        ...
        public static class Java implements IBoundObject {
          ...
          /**
           * Constructs a new
           * {@code dev.metaschema.databind.config.binding.MetaschemaBindings.MetaschemaBinding.DefineFieldBinding.PropertyBinding.Java}
           * instance with no metadata.
           */
          public Java() {
            this(null);
