...
class FnDaysFromDurationTest
  ...
  private static Stream<Arguments> provideValues() { // NOPMD - false positive
    return Stream.of(
        Arguments.of(
            integer(3),
            "fn:days-from-duration(meta:day-time-duration('P3DT10H'))"),
        Arguments.of(
            integer(5),
            "fn:days-from-duration(meta:day-time-duration('P3DT55H'))"),
        Arguments.of(
            integer(0),
            "fn:days-from-duration(meta:year-month-duration('P3Y5M'))"),
        Arguments.of(
            integer(-3),
            "fn:days-from-duration(meta:day-time-duration('-P3DT10H'))"));
  }
