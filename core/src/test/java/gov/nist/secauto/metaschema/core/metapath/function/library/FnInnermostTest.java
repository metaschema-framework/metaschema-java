...
class FnInnermostTest
  ...
  private static Stream<Arguments> provideValues() { // NOPMD - false positive
    return Stream.of(
        Arguments.of(
            ...
            "innermost((.,/root,/root/assembly,/root/assembly/@assembly-flag,/root/field,/root/field/@field-flag))"),
        Arguments.of(
            "(/root/assembly,/root/field)",
            "innermost((.,/root,/root/assembly,/root/field))"),
        Arguments.of(
            "(/root/assembly/@assembly-flag,/root/field/@field-flag)",
            "innermost((.,/root,/root/assembly,/root/assembly/@assembly-flag,/root/field,/root/field/@field-flag," +
  ...
  void test(@NonNull String expectedMetapath, @NonNull String metapath) {
    DynamicContext dynamicContext = newDynamicContext();
    INodeItem node = MockedDocumentGenerator.generateDocumentNodeItem(getContext());

    ISequence<? extends INodeItem> expected
        = IMetapathExpression.compile(expectedMetapath, dynamicContext.getStaticContext())
            .evaluate(node, dynamicContext);

    ISequence<? extends INodeItem> actual = IMetapathExpression.compile(metapath, dynamicContext.getStaticContext())
        .evaluate(node, dynamicContext);
