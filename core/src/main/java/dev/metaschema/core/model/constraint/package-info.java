 ...
 * <ul>
 * <li>{@link dev.metaschema.core.model.constraint.IAllowedValuesConstraint} -
 * Restricts values to a defined set</li>
 * <li>{@link dev.metaschema.core.model.constraint.ICardinalityConstraint} -
 * Enforces occurrence requirements (min/max)</li>
 * <li>{@link dev.metaschema.core.model.constraint.IExpectConstraint} -
 * Validates that a condition is true</li>
 * <li>{@link dev.metaschema.core.model.constraint.IMatchesConstraint} -
 * Validates values against regex patterns</li>
 * <li>{@link dev.metaschema.core.model.constraint.IUniqueConstraint} - Ensures
 * uniqueness of key field combinations</li>
 * <li>{@link dev.metaschema.core.model.constraint.IIndexConstraint} - Creates
 * an index over items for referential integrity</li>
 * <li>{@link dev.metaschema.core.model.constraint.IIndexHasKeyConstraint} -
 * Verifies that references exist in an index</li>
 * </ul>
 * <h2>Validation</h2>
 * <p>
 * The {@link dev.metaschema.core.model.constraint.DefaultConstraintValidator}
 ...
 * {@link dev.metaschema.core.model.constraint.IConstraintValidationHandler}
 * implementations.
 * <h2>Usage Context</h2>
 * <p>
 * Constraints can be:
 ...
 * </ul>
 *
 * @see dev.metaschema.core.model.constraint.IConstraint
 * @see dev.metaschema.core.model.constraint.IConstraintValidator
 */
