 ...
 * interfaces defined in the parent {@link dev.metaschema.core.model.constraint}
 * package. These implementations provide the runtime behavior for constraint
 * evaluation and validation.
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultAllowedValuesConstraint}
 * - Implementation of allowed values restrictions</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultCardinalityConstraint}
 * - Implementation of cardinality enforcement</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultExpectConstraint}
 * - Implementation of expectation validation</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultMatchesConstraint}
 * - Implementation of pattern matching</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultUniqueConstraint}
 * - Implementation of uniqueness checking</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultIndexConstraint}
 * - Implementation of index creation</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.DefaultIndexHasKeyConstraint}
 * - Implementation of referential integrity checking</li>
 * <li>{@link dev.metaschema.core.model.constraint.impl.AbstractConstraint} -
