 ...
 * {@link dev.metaschema.core.model} package</li>
 * <li>Databinding implementations that need to navigate model structures</li>
 * </ul>
 *
 * @see dev.metaschema.core.model.IContainerFlagSupport
 * @see dev.metaschema.core.model.IContainerModelSupport
 * @see dev.metaschema.core.model.AbstractContainerModelSupport
 */
