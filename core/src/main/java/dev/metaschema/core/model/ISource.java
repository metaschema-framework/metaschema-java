...
public interface ISource {
   ...
   * {@link dev.metaschema.core.model.ISource.SourceLocation#MODEL} source with as
   * associated resource.
   *
   * @param module
  ...
  /**
   * Get the descriptor for a
   * {@link dev.metaschema.core.model.ISource.SourceLocation#EXTERNAL} source for
  ...
  /**
   * Get the descriptor for a
   * {@link dev.metaschema.core.model.ISource.SourceLocation#EXTERNAL} source with
