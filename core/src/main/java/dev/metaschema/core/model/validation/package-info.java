 ...
 * <ul>
 * <li>{@link dev.metaschema.core.model.validation.IContentValidator} - Common
 * interface for content validators</li>
 * <li>{@link dev.metaschema.core.model.validation.XmlSchemaContentValidator} -
 * Validates XML content against XML Schema (XSD)</li>
 * <li>{@link dev.metaschema.core.model.validation.JsonSchemaContentValidator} -
 * Validates JSON content against JSON Schema</li>
 * <li>{@link dev.metaschema.core.model.validation.IValidationResult} -
 * Represents the outcome of a validation operation</li>
 * <li>{@link dev.metaschema.core.model.validation.IValidationFinding} -
 * Represents an individual validation issue or error</li>
 * </ul>
 * <h2>Usage Context</h2>
 * <p>
 * This validation framework differs from constraint validation
 * ({@link dev.metaschema.core.model.constraint.IConstraint}) in that it:
 * <ul>
 ...
 * cardinality), use the
 * {@link dev.metaschema.core.model.constraint.IConstraint} instead.
 *
