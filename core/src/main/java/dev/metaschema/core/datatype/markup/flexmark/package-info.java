 ...
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.FlexmarkConfiguration}
 ...
 * headings</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.HtmlCodeRenderExtension}
 * - Custom rendering for inline code elements</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.SuppressPTagExtension}
 * - Suppresses paragraph tags in single-line markup</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.FixedEmphasisDelimiterProcessor}
 * - Fixes emphasis delimiter processing for Metaschema requirements</li>
 * </ul>
 * <h2>Visitors and Writers</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.IMarkupVisitor}
 * - Interface for visiting markup AST nodes</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.MarkupVisitor} -
 * Default visitor implementation for processing markup nodes</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.IMarkupWriter} -
 * Interface for writing markup to various output formats</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.MarkupXmlEventWriter}
 * - Writes markup as XML events (StAX event-based API)</li>
 * <li>{@link dev.metaschema.core.datatype.markup.flexmark.impl.MarkupXmlStreamWriter}
 * - Writes markup as XML stream (StAX stream-based API)</li>
 * </ul>
 * <h2>Usage Context</h2>
 * <p>
 * This package is primarily used internally by the
 * {@link dev.metaschema.core.datatype.markup} package to handle the low-level
 * parsing and rendering of markup content. The Flexmark extensions ensure that
 * Metaschema markup conforms to specification requirements while supporting a
 * rich subset of Markdown and HTML features.
 */

package dev.metaschema.core.datatype.markup.flexmark;
