 ...
 * <ul>
 * <li>Parent {@link dev.metaschema.core.datatype.markup.flexmark} package for
 * public markup processing APIs</li>
 * <li>{@link dev.metaschema.core.datatype.markup} for higher-level markup data
 * type support</li>
 * <li>XML and JSON serialization components that need to render markup
 * content</li>
 * </ul>
 *
 * @see dev.metaschema.core.datatype.markup.flexmark
 * @see dev.metaschema.core.datatype.markup
 */

package dev.metaschema.core.datatype.markup.flexmark.impl;
