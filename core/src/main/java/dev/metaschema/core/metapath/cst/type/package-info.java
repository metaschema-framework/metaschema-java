 ...
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.cst.type.AbstractCastingExpression} -
 * Base class for casting-related expressions</li>
 * <li>{@link dev.metaschema.core.metapath.cst.type.Cast} - Implements the
 * <a href="https://www.w3.org/TR/xpath-31/#id-cast">"cast as" operator</a> for
 * explicit type conversion</li>
 * <li>{@link dev.metaschema.core.metapath.cst.type.Castable} - Implements the
 * <a href="https://www.w3.org/TR/xpath-31/#id-castable">"castable as"
 * operator</a> for testing type conversion feasibility</li>
 * <li>{@link dev.metaschema.core.metapath.cst.type.InstanceOf} - Implements the
 * <a href="https://www.w3.org/TR/xpath-31/#id-instance-of">"instance of"
 * operator</a> for runtime type testing</li>
 * <li>{@link dev.metaschema.core.metapath.cst.type.Treat} - Implements the
 * <a href="https://www.w3.org/TR/xpath-31/#id-treat">"treat as" operator</a>
 * for type assertion with runtime verification</li>
 * <li>{@link dev.metaschema.core.metapath.cst.type.TypeTestSupport} - Utility
 * class for type testing operations</li>
 * </ul>
 *
