 ...
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.format.IPathFormatter} - Core
 * interface defining the contract for path formatters with implementations for
 * different path syntaxes</li>
 * <li>{@link dev.metaschema.core.metapath.format.IPathSegment} - Represents a
 * single segment in a path, providing navigation to parent segments and access
 * to associated node items</li>
 * <li>{@link dev.metaschema.core.metapath.format.MetapathFormatter} - Produces
 * Metapath expression syntax for paths (e.g.,
 * {@code /root/assembly[1]/field[1]})</li>
 * <li>{@link dev.metaschema.core.metapath.format.XPathFormatter} - Produces
 * XPath 3.1 paths with EQName-qualified names (e.g.,
 * {@code /Q{http://example.com}root/Q{http://example.com}assembly[1]})</li>
 * <li>{@link dev.metaschema.core.metapath.format.JsonPointerFormatter} -
