 ...
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.function.IFunction} - Represents a
 * function signature with its name, arguments, return type, and properties</li>
 * <li>{@link dev.metaschema.core.metapath.function.IFunctionLibrary} - Provides
 * access to a collection of function signatures</li>
 * <li>{@link dev.metaschema.core.metapath.function.IFunctionExecutor} -
 * Executes a function with provided arguments</li>
 * <li>{@link dev.metaschema.core.metapath.function.IArgument} - Represents a
 * single function argument signature</li>
 * </ul>
 *
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.function.DefaultFunction} - Concrete
 * implementation of a function signature</li>
 * <li>{@link dev.metaschema.core.metapath.function.FunctionService} -
 * Service-based function discovery using Java ServiceLoader</li>
 * <li>{@link dev.metaschema.core.metapath.function.FunctionLibrary} - Registry
 * for organizing and looking up functions</li>
 * </ul>
 *
 * <h2>Usage</h2>
 * <p>
