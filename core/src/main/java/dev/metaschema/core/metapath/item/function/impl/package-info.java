 ...
 * interfaces defined in {@link dev.metaschema.core.metapath.item.function}.
 * These classes provide immutable, efficient implementations of arrays and maps
 * for use in Metapath expressions.
 *
 * <h2>Array Implementations</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.AbstractArrayItem}
 * - Base class for all array item implementations, providing common utility
 * methods</li>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.ArrayItemN} -
 * Array implementation that supports an unbounded number of members</li>
 * </ul>
 *
 * <h2>Map Implementations</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.AbstractMapItem} -
 * Base class for all map item implementations, providing common utility methods
 * including the function call interface for map lookup</li>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.MapItemN} - Map
 * implementation that supports an unbounded number of entries</li>
 * </ul>
 *
 * <h2>Map Key Implementations</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.AbstractStringMapKey}
 * - Base implementation for string-based map keys</li>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.AbstractKeySpecifier}
 * - Base implementation for key specifier that computes keys from items</li>
 * </ul>
 *
 * <h2>Utility Classes</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.ImmutableCollections}
 * - Utility classes for creating immutable collection wrappers</li>
 * </ul>
 *
 * <h2>Exceptions</h2>
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.function.impl.ArrayMetapathException}
 ...
 *
 * @see dev.metaschema.core.metapath.item.function
 */
