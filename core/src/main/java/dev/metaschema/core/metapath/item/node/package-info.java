 ...
 * <ul>
 * <li>{@link dev.metaschema.core.metapath.item.node.INodeItem} - Base interface
 * for all node items</li>
 * <li>{@link dev.metaschema.core.metapath.item.node.IDocumentNodeItem} -
 * Document root node representing a data instance</li>
 * <li>{@link dev.metaschema.core.metapath.item.node.IAssemblyNodeItem} -
 * Assembly nodes containing nested structures</li>
 * <li>{@link dev.metaschema.core.metapath.item.node.IFieldNodeItem} - Field
 * nodes containing values and flags</li>
 * <li>{@link dev.metaschema.core.metapath.item.node.IFlagNodeItem} - Flag nodes
 * containing simple values</li>
 * <li>{@link dev.metaschema.core.metapath.item.node.IModuleNodeItem} - Module
 * definition nodes representing Metaschema schemas</li>
 * </ul>
 * <p>
 * Node items support:
 * <ul>
 ...
 * {@link dev.metaschema.core.metapath.item.node.IAtomicValuedNodeItem}</li>
 * <li>Visitor pattern traversal via
 * {@link dev.metaschema.core.metapath.item.node.INodeItemVisitor}</li>
 * <li>Factory-based creation through
 * {@link dev.metaschema.core.metapath.item.node.INodeItemFactory}</li>
 * </ul>
 * <p>
 * Node items integrate with Metaschema model definitions in
 * {@link dev.metaschema.core.model}, providing runtime representations that can
