...
public final class TypeSystem {
  ...
  private static final Map<Class<? extends IAnyAtomicItem>, QName> ITEM_CLASS_TO_QNAME_MAP;
  ...
  static {
    ...
    Stream<Map.Entry<Class<? extends IAnyAtomicItem>, QName>> basicAdapterStream
        = new MetaschemaDataTypeProvider().getJavaTypeAdapters().stream()
            .map(adapter -> Map.entry(adapter.getItemClass(), adapter.getPreferredName()));
    Stream<Map.Entry<Class<? extends IAnyAtomicItem>, QName>> markupAdapterStream
  ...
  private static Map.Entry<Class<? extends IItem>, IItemType> register(
    ...
    return register(IItemType.type(adapter));
  }
