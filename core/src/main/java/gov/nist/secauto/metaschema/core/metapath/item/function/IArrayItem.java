...
public interface IArrayItem<ITEM extends IArrayMember> extends IFunction, IItem, List<ITEM> {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of() {
    return AbstractArrayItem.empty();
  }
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5, T e6) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5, T e6, T e7) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5, T e6, T e7, T e8) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5, T e6, T e7, T e8, T e9) {
   ...
   */
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(T e1, T e2, T e3, T e4, T e5, T e6, T e7, T e8, T e9, T e10) {
  ...
  @SafeVarargs
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> of(@NonNull T... items) {
  ...
  @NonNull
  static <T extends IArrayMember> IArrayItem<T> copyOf(Collection<? extends T> collection) {
